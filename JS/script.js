...
for (let i = 0; i < span.length; i++) {
  ...
  span[i].addEventListener('mousemove', function () {
    ...
    // change the background color of the span if isMouseDown is true while mouse is moving
  ...
  // change the background color of the last span when the mouse is released
